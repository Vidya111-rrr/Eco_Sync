    ...
    <div className="selection-container">
      ...
      <div className="selection-cards">
        <div className="selection-card">
          ...
          <button onClick={() => navigate('/waste-collection-form')}>Go to Waste Collection</button>
        </div>
        <div className="selection-card">
          ...
          <button onClick={() => navigate('/recycling-services-form')}>Go to Recycling Services</button>
        </div>
      </div>
    </div>
  );
